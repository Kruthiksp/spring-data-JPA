...
public class InputUtil {
	...
	public static OwnerDTO ownerDetailsToSave(Scanner sc) {
		System.out.println("Enter Owner Name: ");
		String name = sc.next();
		System.out.println("Enter owner mail Id: ");
		String email = sc.next();

		ProductDTO productDetailsToSave = productDetailsToSave(sc);

		OwnerDTO ownerTosave = new OwnerDTO();
		ownerTosave.setName(name);
		ownerTosave.setEmail(email);
		ownerTosave.setProductDTO(productDetailsToSave);
